...
import {HubInterfacesOptions, HubInterface, CommitStrategyReference } from './hubInterfaces/HubInterfaces';
...
export { HubInterfacesOptions as HubMethodsOptions, HubInterface, CommitStrategyReference };
