...
class IssuanceServiceTest {
    ...
    private val issuanceService =
        spyk(IssuanceService(identifierManager, exchangeService, linkedDomainsService, mockk(relaxed = true), mockedJwtValidator, issuanceResponseFormatter, mockk()))
