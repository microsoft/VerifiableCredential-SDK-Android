...
open class VcSdkException(message: String? = null, cause: Throwable? = null) : Exception(message, cause)

class UnSupportedOperationException(message: String? = null, cause: Throwable? = null) : VcSdkException(message, cause)

open class CryptoException(message: String? = null, cause: Throwable? = null) : VcSdkException(message, cause)
...
open class AuthenticationException(message: String? = null, cause: Throwable? = null) : VcSdkException(message, cause)
...
class ValidatorException(message: String? = null, cause: Throwable? = null) : VcSdkException(message, cause)

class ResolverException(message: String? = null, cause: Throwable? = null) : VcSdkException(message, cause)

class RegistrarException(message: String? = null, cause: Throwable? = null) : VcSdkException(message, cause)

open class NetworkException(message: String? = null, cause: Throwable? = null) : VcSdkException(message, cause)
...
class RepositoryException(message: String? = null, cause: Throwable? = null) : VcSdkException(message, cause)
