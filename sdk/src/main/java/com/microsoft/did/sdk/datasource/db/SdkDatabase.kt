...
import com.microsoft.did.sdk.datasource.db.dao.VerifiableCredentialContainerDao
 ...
 */
@Database(entities = [VerifiableCredential::class, VerifiableCredentialContainer::class, Identifier::class, Receipt::class], version = 1)
@TypeConverters(RoomConverters::class)
abstract class SdkDatabase : RoomDatabase() {

    abstract fun cardDao(): VerifiableCredentialContainerDao
