...
enum class LinkedDataKeySpecification(val values: List<String>) {
    ...
    EcdsaSecp256k1Signature2019(listOf("Secp256k1VerificationKey2019","Secp256k1VerificationKey2018", "EcdsaSecp256k1VerificationKey2019", "EcdsaSecp256k1Signature2019"))
}