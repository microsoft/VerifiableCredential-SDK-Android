...
data class IdentityHubService(
    override val id: String,
    override val type: String = "IdentityHub",
    val publicKey: String,
    @Polymorphic override val serviceEndpoint: Endpoint
    ...
    companion object {
        fun create(id: String, signatureKeyRef: String, instances: List<Identifier>, keyStore: KeyStore): IdentifierDocumentService {
            ...
            return IdentityHubService(
                id,
                publicKey = keyId.getLatestKeyId(),
                serviceEndpoint = UserHubEndpoint(instances = didList)
            )
        }
    }
}